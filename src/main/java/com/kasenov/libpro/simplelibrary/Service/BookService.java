...
public interface BookService{
    ...
    ResponseEntity<Objects> saveBook(Book book) throws CannotSaveException;

    ResponseEntity<Objects> updateBook(Book book) throws NotFoundException, CannotSaveException;
